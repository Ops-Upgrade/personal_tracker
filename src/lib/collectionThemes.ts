...
/**
 * Convert an HSL hue (0-360) to a hex string.
 * Saturation and lightness are fixed at 100% / 50% for the hue-slider picker.
 */
...
/**
 * Extract the approximate hue (0-360) from a hex color.
 * Used to initialise the hue slider position.
 */
